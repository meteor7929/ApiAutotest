...
def get_project_path():
    ...
    # print
    ck = os.path.dirname(cd)  # D:\ApiAutoTest\zonghe
    # print(ck)
...
def read_yaml(fil_path):
    '''
    读取yaml文件
    :param fil_path: yaml文件路径
    :return: 文件内容
    '''
    file_path = get_project_path() + fil_path
...
if __name__ == '__main__':
    get_project_path()
    #     url = read_ini(r'data_env\env.ini', 'url')  # 相对路径,其他电脑上也可以使用
    #     print(url)
    #
